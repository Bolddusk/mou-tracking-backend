/**
 * Import historic Agri Technology MOUs from Islamabad B2B conference (hardcoded list).
 *
 * Run once (idempotent via external_reference):
 *   npm run db:import:islamabad-agri-tech-mous
 */
...
const {
  ...
  buildProposalRecord,
} = require('../utils/islamabadAgriTechMouImport');
...
async function importRows() {
  console.log('\n=== Import Islamabad Agri Tech MOUs ===');
  ...
  const rows = getIslamabadAgriTechRows();
