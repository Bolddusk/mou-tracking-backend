/**
 * Import historic Fisheries & Aquaculture MOUs from Islamabad B2B conference.
 *
 * Run once (idempotent via external_reference):
 *   npm run db:import:islamabad-agri-fisheries-mous
 */
...
const {
  ...
  buildProposalRecord,
} = require('../utils/islamabadAgriFisheriesMouImport');
...
async function importRows() {
  console.log('\n=== Import Islamabad Agri Fisheries MOUs ===');
  ...
  const rows = getIslamabadAgriFisheriesRows();
