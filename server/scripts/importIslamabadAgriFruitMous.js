/**
 * Import historic Fruits & Vegetables MOUs from Islamabad B2B conference.
 *
 * Run once (idempotent via external_reference):
 *   npm run db:import:islamabad-agri-fruit-mous
 */
...
const {
  ...
  buildProposalRecord,
} = require('../utils/islamabadAgriFruitMouImport');
...
async function importRows() {
  console.log('\n=== Import Islamabad Agri Fruits & Vegetables MOUs ===');
  ...
  const rows = getIslamabadAgriFruitRows();
