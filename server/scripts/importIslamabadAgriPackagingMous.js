/**
 * Import historic Food Grade Packaging MOUs from Islamabad B2B conference.
 *
 * Run once (idempotent via external_reference):
 *   npm run db:import:islamabad-agri-packaging-mous
 */
...
async function importRows() {
  console.log('\n=== Import Islamabad Agri Packaging MOUs ===');
  console.log('Conference: PAKISTAN-CHINA Agriculture B2B Investment Conference, Islamabad');
  console.log('Sub-sector: Food Grade Packaging Materials & Equipment\n');
  ...
  const rows = getIslamabadAgriPackagingRows();
