/**
 * Import historic Cold Chain MOUs from Islamabad B2B conference (hardcoded list).
 *
 * Run once (idempotent via external_reference):
 *   npm run db:import:islamabad-agri-coldchain-mous
 */
...
const {
  ...
  buildProposalRecord,
} = require('../utils/islamabadAgriColdChainMouImport');
...
async function importRows() {
  console.log('\n=== Import Islamabad Agri Cold Chain MOUs ===');
  console.log('Conference: PAKISTAN-CHINA Agriculture B2B Investment Conference, Islamabad');
  console.log('Sub-sector: Cold Chain and Agricultural Logistics\n');
  ...
  const rows = getIslamabadAgriColdChainRows();
